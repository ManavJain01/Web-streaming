...
export default function Login() {
  ...
  return (
    <div className='relative'>
      ...
      <form onSubmit={getInputData} className='absolute left-0 right-0 bg-black w-3/12 p-12 my-36 mx-auto flex flex-col items-center justify-center rounded-md opacity-90'>
          ...
          <div className='flex flex-col'>
            ...
            <p className='text-white mt-2'>{isLogin ? `New to ${import.meta.env.VITE_REACT_APP_Website_Name}?` : "Already have an account?"}<span onClick={loginHandler} className='ml-1 text-blue-900 font-medium cursor-pointer'>{isLogin ? "Signup" : "Login"}</span></p>
          </div>
      </form>
    </div>
  )
